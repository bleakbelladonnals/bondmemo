...
If your Debian release does not provide PHP 8.2 or newer, use the [deb.sury.org](https://deb.sury.org/) package repository from Ondřej Surý, maintainer of the mainline Debian packages.
...
Install PHP 8.2 with these extensions:
...
Run:
```sh
sudo apt install -y php8.2 php8.2-bcmath php8.2-curl php8.2-gd php8.2-gmp \
    php8.2-intl php8.2-mbstring php8.2-mysql php8.2-redis php8.2-tokenizer php8.2-xml php8.2-zip
```
