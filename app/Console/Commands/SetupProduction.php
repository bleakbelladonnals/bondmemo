...
class SetupProduction extends Command
{
     ...
     * @var string
     */
    protected $description = 'Perform setup of BondMemo.';
    ...
    {
        if ((! $this->option('force')) && (! $this->confirm('You are about to setup and configure BondMemo. Do you wish to continue?'))) {
            return;
        }
        ...
        $this->line('-----------------------------');
        $this->line('|');
        $this->line('| Welcome to BondMemo v'.config('monica.app_version'));
        $this->line('|');
        $this->line('-----------------------------');
