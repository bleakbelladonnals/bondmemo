...
Route::middleware(['auth', 'verified', 'mfa'])->group(function () {
    Route::get('/assistant/quick-record', 'RelationshipAgentController@index')->name('assistant.quick-record');
    Route::post('/assistant/quick-record', 'RelationshipAgentController@store')->name('assistant.quick-record.store');
    Route::middleware('throttle:relationship-agent')->group(function () {
        Route::post('/assistant/quick-record/analyze', 'RelationshipAgentController@analyze')->name('assistant.quick-record.analyze');
        Route::post('/assistant/people/{contact}/brief', 'RelationshipAgentController@brief')->name('assistant.people.brief');
    });
