<nav class="bondmemo-header bg-blue-monica">
  <div class="ph3 ph5-ns pv2 cf w-100">
    <div class="mw9 center dt w-100">
      <div class="w-50-l w-100 dtc-l v-mid">
        <div class="tc dib-l">
          <a href="{{ route('dashboard.index') }}" class="header-logo {{ htmldir() == 'rtl' ? 'ml3' : 'mr3' }}" aria-label="BondMemo">
            <img src="img/bondmemo.svg" width="36" height="36" alt="">
            <span>BondMemo</span>
          </a>
        </div>
      ...
      <div class="w-50-l w-100 dtc-l v-mid tl tr-l">
        <div class="header-nav">
          <a href="{{ route('assistant.quick-record') }}" class="header-nav-item-link assistant-nav-cta dib">
            <span aria-hidden="true">+</span> {{ trans('assistant.quick_record_nav') }}
          </a>
