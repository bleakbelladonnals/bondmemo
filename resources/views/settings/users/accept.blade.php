      ...
      <div class="row">
        <div class="col-12 col-md-6 offset-md-3 offset-md-3-right">
          ...
          <div class="signup-box">
            <div class="dt w-100">
              <div class="dtc tc">
                <img src="img/bondmemo.svg" width="97" height="88" alt="BondMemo">
              </div>
            </div>
            ...
            <form action="{{ route('invitations.send', $key) }}" method="post">
              ...
              <div class="form-check">
                <label class="form-check-label">
                  ...
                  {!! trans('auth.register_policy', ['url' => config('app.privacy_url') ?: '#', 'urlterm' => config('app.terms_url') ?: '#', 'hreflang' => 'en', ]) !!}
                </label>
              </div>
