...
<html lang="{{ \App::getLocale() }}" dir="{{ htmldir() }}">
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="BondMemo">
    <meta name="application-name" content="BondMemo">
    <meta name="theme-color" content="#5267d8">
    ...
    <link rel="shortcut icon" href="img/bondmemo.svg" type="image/svg+xml">

    <link rel="apple-touch-icon" href="img/icons/bondmemo-120.png">
    <link rel="apple-touch-icon" sizes="152x152" href="img/icons/bondmemo-152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="img/icons/bondmemo-180.png">

    <link rel="shortcut icon" sizes="196x196" href="img/icons/bondmemo-196.png">
  ...
  <body data-account-id="{{ auth()->user()->account_id }}" class="bondmemo-app bg-gray-monica min-vh-100 flex flex-column">
