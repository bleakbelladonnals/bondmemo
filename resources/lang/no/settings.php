...
return [
    ...
    'me_help' => 'Dette er den kontakten som representerer <em>deg</em> i BondMemo',
    ...
    'export_sql_explanation' => 'Exporting your data in SQL format allows you to take your data and import it to your own BondMemo instance. This is only valuable if you do have your own server.',
    ...
    'email_help' => 'Dette er e-postadressen som brukes til å logge inn, og det er hit BondMemo sender deg påminnelser.',
    'timezone' => 'Tidssone',
    ...
    'locale_help' => 'Vil du hjelpe med å oversette BondMemo eller legge til et nytt språk? Følg <a href=":url" target="_blank" lang="en">denne linken for mer informasjon</a>.',
    'locale_ar' => 'Arabisk',
    'locale_cs' => 'Tsjekkisk',
    'locale_de' => 'Tysk',
    'locale_el' => 'Gresk',
    ...
    'users_list_invitations_explanation' => 'Nedenfor er de du har invitert til å bli med i BondMemo som samarbeidspartner.',
    ...
    'subscriptions_account_upgrade_title' => 'Oppgrader BondMemo i dag og få mer meningsfylte forhold.',
    'subscriptions_account_upgrade_choice' => 'Velg en plan nedenfor og bli med :customers personer som har oppgradert sin BondMemo.',
    'subscriptions_account_update_title' => 'Oppdater BondMemo-abonnement',
    ...
    'subscriptions_downgrade_thanks' => 'Takk så mye for å prøve den betalte planen. Vi har lagt til nye funksjoner på BondMemo hele tiden, slik at du kanskje vil komme tilbake i fremtiden for å se om du kanskje er interessert i å melde deg på igjen.',
    ...
    'subscriptions_help_opensource_desc' => 'BondMemo er et åpen kildekode-prosjekt. Det betyr at det blir bygget av et samfunn som ønsker å bygge et flott verktøy for mer godt. Å være åpen kildekode betyr at koden er offentlig tilgjengelig på GitHub, og alle kan inspisere den, endre koden eller forbedre den. Alle pengene vi skaffer oss er opptatt av å bygge bedre funksjoner, betale for mer kraftfulle servere og betale andre kostnader. Takk for din hjelp. Vi kunne ikke gjøre det uten deg.',
    ...
    'subscriptions_help_discounts_desc' => 'Vi gjør! BondMemo er gratis for studenter, og gratis for ikke-fortjeneste og veldedighet. Bare kontakt <a href=":support">brukerstøtte</a> med bevis på din status, og vi bruker denne spesielle statusen i kontoen din.',
    ...
    'api_description' => 'API-et kan brukes til å manipulere BondMemos data fra en ekstern applikasjon, for eksempel en mobilapplikasjon.',
    ...
    'api_endpoint' => 'API-endepunktet for dette BondMemo-eksempelet er:',
    ...
    'personalization_title' => 'Her finner du forskjellige innstillinger for å konfigurere kontoen din. Disse funksjonene er ment for "avanserte brukere" som vil ha maksimal kontroll over BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'For hver påminnelse du angir, kan BondMemo sende deg en e-post med en rekke dager før arrangementet skjer. Du kan justere disse varslingsinnstillingene her. Disse varslene gjelder bare for månedlige og årlige påminnelser.',

    'personalization_module_save' => 'Endringen er lagret',
    'personalization_module_title' => 'Funksjoner',
    'personalization_module_desc' => 'Det er mulig at du ikke trenger alle funksjonene til BondMemo. Nedenfor kan du endre bestemte funksjoner som brukes på et kontaktark. Denne endringen vil påvirke ALLE kontaktene dine. Ved å skru av en funksjon sletter du ikke data, vil den bare skjules funksjonen.',
