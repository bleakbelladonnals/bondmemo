...
return [
    ...
    'confirmation_email_title' => 'BondMemo - verifiser e-post',
    ...
    'password_reset_title' => 'BondMemo - forespørsel om å nullstille passord',
    ...
    'invitation_title' => 'BondMemo - :name har invitert deg',
    'invitation_intro' => 'Du har blitt invitert av :name (:email) til å bruke BondMemo, et hyggelig verktøy for å holde styr på dine forhold.',
