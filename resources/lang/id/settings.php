...
return [
    ...
    'me_help' => 'Ini adalah kontak yang mewakili <em>Anda</em> dalam BondMemo',
    ...
    'email_help' => 'Ini adalah email yang digunakan untuk masuk, dan di alamat inilah BondMemo akan mengirim pengingat Anda.',
    'timezone' => 'Zona waktu',
    ...
    'locale_help' => 'Apakah Anda ingin membantu menerjemahkan BondMemo atau menambahkan bahasa baru? Silakan ikuti <a href=":url" target="_blank" lang="en">tautan ini untuk informasi lebih lanjut</a>.',
    'locale_ar' => 'Arab',
    'locale_cs' => 'Ceko',
    'locale_de' => 'Jerman',
    'locale_el' => 'Greek',
    ...
    'users_list_invitations_explanation' => 'Di bawah ini adalah orang yang telah Anda undang untuk bergabung dengan BondMemo sebagai kolaborator.',
    ...
    'subscriptions_account_upgrade_title' => 'Tingkatkan BondMemo hari ini dan memiliki hubungan yang lebih bermakna.',
    'subscriptions_account_upgrade_choice' => 'Pilih sebuah paket rencana di bawah ini dan bergabunglah dengan :customers pelanggan yang meningkatkan aplikasi BondMemo mereka.',
    ...
    'subscriptions_downgrade_thanks' => 'Terima kasih banyak telah mencoba paket rencana berbayar. Kami terus menambahkan fitur baru di BondMemo sepanjang waktu - sehingga Anda mungkin ingin kembali pada kesempatan mendatang untuk melihat apakah Anda mungkin tertarik untuk berlangganan lagi.',
    ...
    'subscriptions_help_discounts_desc' => 'Kami punya! BondMemo gratis untuk siswa, dan gratis untuk organisasi non-profit dan amal. Cukup hubungi<a href=":support">dukungan</a> dengan bukti status Anda dan kami akan terapkan status khusus ini pada akun Anda.',
    ...
    'api_title' => 'Akses API',
    'api_description' => 'API dapat digunakan untuk memanipulasi data BondMemo dari aplikasi eksternal, seperti aplikasi seluler misalnya.',
    ...
    'api_endpoint' => 'Endpoint API untuk contoh pemasangan BondMemo ini adalah:',
    ...
    'personalization_title' => 'Di sini Anda akan menemukan pengaturan yang berbeda untuk mengkonfigurasi akun Anda. Fitur ini ditujukan untuk "pengguna super" yang menginginkan kontrol maksimum atas BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'Untuk setiap pengingat yang Anda telah atur, BondMemo dapat mengirimkan email kepada Anda beberapa hari sebelum peristiwa terjadi.  Anda dapat menyesuaikan pengaturan pemberitahuan ini di sini. Pemberitahuan ini hanya berlaku untuk pengingat bulanan dan tahunan.',

    'personalization_module_save' => 'Perubahan telah disimpan',
    'personalization_module_title' => 'Fitur',
    'personalization_module_desc' => 'Anda mungkin tidak memerlukan semua fitur BondMemo. Di bawah ini Anda dapat mengaktifkan fitur spesifik yang digunakan pada sebuah lembar kontak. Perubahan ini akan memengaruhi SEMUA kontak Anda. Menonaktifkan sebuah fitur tidak akan menghapus data apapun, hanya menyembunyikan fitur tersebut.',
