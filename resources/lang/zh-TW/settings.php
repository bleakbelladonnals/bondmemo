...
return [
    ...
    'me_help' => '這個聯絡人在BondMemo代表了 <em>你</em>',
    'me_select' => '選擇聯絡人',
    ...
    'locale' => '應用程式中使用的語言',
    'locale_help' => '您想要幫助翻譯BondMemo或新增新語言嗎？請點選 <a href=":url" target="_blank" lang="en">瞭解更多資訊</a>。',
    'locale_ar' => '阿拉伯文',
    'locale_cs' => '捷克文',
    'locale_de' => '德文',
    'locale_el' => '希臘語',
    ...
    'subscriptions_account_upgrade_title' => '立即升級您的BondMemo賬戶吧！',
    ...
    'subscriptions_help_discounts_desc' => '當然！BondMemo免費為學生，非盈利機構提供服務。您只需要提交一下材料給我們的 <a href=":support">支援人員</a>。',
