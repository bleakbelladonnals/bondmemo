...
return [
    ...
    'confirmation_email_title' => 'BondMemo – Email 認證',
    ...
    'password_reset_title' => 'BondMemo — 重置密碼通知',
    ...
    'invitation_title' => 'BondMemo — 您收到 :name 的邀請',
    'invitation_intro' => '您已被:name (:email)邀請使用 BondMemo, 個人社交關係管理工具。',
