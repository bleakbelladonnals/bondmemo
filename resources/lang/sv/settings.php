...
return [
    ...
    'me_help' => 'Detta är den kontakt som representerar <em>du</em> i BondMemo',
    ...
    'locale_help' => 'Vill du hjälpa till att översätta BondMemo eller lägga till ett nytt språk? Följ <a href=":url" target="_blank" lang="en">denna länk för mer information</a>.',
    'locale_ar' => 'Arabiska',
    'locale_cs' => 'Tjeckiska',
    'locale_de' => 'Tyska',
    'locale_el' => 'Greek',
    ...
    'users_list_invitations_explanation' => 'Nedan är de personer som du har bjudit in till BondMemo som samarbetspartner.',
    ...
    'subscriptions_account_upgrade_title' => 'Uppgradera BondMemo idag och ha mer meningsfulla relationer.',
    'subscriptions_account_upgrade_choice' => 'Välj en plan nedan och gå över :customers personer som uppgraderat sin BondMemo.',
    ...
    'subscriptions_help_discounts_desc' => 'Vi gör! BondMemo är gratis för studenter, och gratis för ideella organisationer och välgörenhetsorganisationer. Kontakta bara <a href=":support">supporten</a> med ett bevis på din status så tillämpar vi denna speciella status på ditt konto.',
    ...
    'api_description' => 'API: et kan användas för att manipulera BondMemos data från en extern applikation, som till exempel en mobilapp.',
    ...
    'api_endpoint' => 'API slutpunkt för denna BondMemo instans är:',
