...
return [
    ...
    'me_help' => 'Bu hesap BondMemo\'da <em>sizi</em> temsil eden kişidir',
    ...
    'email_help' => 'This is the email used to login, and this is where BondMemo will send your reminders.',
    ...
    'locale_help' => 'BondMemo\'yı çevirmeye yardım etmek veya yeni bir dil eklemek ister misiniz? Lütfen <a href=":url" target="_blank" lang="en">daha fazla bilgi için bu linki</a> takip edin.',
    'locale_ar' => 'Arapça',
    'locale_cs' => 'Çekçe',
    'locale_de' => 'Almanca',
    'locale_el' => 'Greek',
    ...
    'users_list_invitations_explanation' => 'Birlikte çalışmak için BondMemo\'ya katılmaya davet ettiğiniz kişiler aşağıdadır.',
    ...
    'subscriptions_account_upgrade_title' => 'BondMemo\'yı bugün yükseltin ve daha anlamlı ilişkilere sahip olun.',
    'subscriptions_account_upgrade_choice' => 'Aşağıdaki planlardan birini seçin ve BondMemo\'larını yükselten :customers üzerinde kişinin arasına katılın.',
    'subscriptions_account_update_title' => 'Update BondMemo subscription',
    ...
    'subscriptions_downgrade_thanks' => 'Thanks so much for trying the paid plan. We keep adding new features on BondMemo all the time – so you might want to come back in the future to see if you might be interested in taking a subscription again.',
    ...
    'subscriptions_help_opensource_desc' => 'BondMemo is an open source project.  This means it is built by a community who wants to build a great tool for the greater good. Being open source means the code is publicly available on GitHub, and everyone can inspect it, modify it or enhance it. All the money we raise is dedicated to building better features, paying for more powerful servers, and paying other costs. Thanks for your help. We couldn’t do it without you.',
    ...
    'subscriptions_help_discounts_desc' => 'Evet var! BondMemo öğrencilere ve kâr amacı gütmeyen kuruluşlara ücretsizdir. Sadece durumunuz ile ilgili bir kanıt ile birlikte <a href=":support">destek</a> ile iletişime geçin ve hesabınıza bu özel duruma uygun hale getirelim.',
    ...
    'api_description' => 'API, BondMemo’nın verilerini harici bir uygulamadan, örneğin bir mobil uygulama gibi, yönetmek için kullanılabilir.',
    ...
    'api_endpoint' => 'Bu BondMemo örneğinin API uç noktası:',
    ...
    'personalization_title' => 'Here you will find different settings to configure your account. These features are intended for “power users” who want maximum control over BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'For every reminder that you set, BondMemo can send you an email a number of days before the event happens.  You can adjust these notification settings here. These notifications only apply to monthly and yearly reminders.',

    'personalization_module_save' => 'Değişiklik kaydedildi',
    'personalization_module_title' => 'Özellikler',
    'personalization_module_desc' => 'You may not need all of BondMemo’s features. Below you can toggle specific features that are used on a contact sheet. This change will affect ALL your contacts. Turning off a feature does not delete any data, it simply hides the feature.',
