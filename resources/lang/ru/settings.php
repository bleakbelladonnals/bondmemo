...
return [
    ...
    'me_help' => 'Это контакт, который представляет <em>вас</em> в BondMemo',
    ...
    'email_help' => 'Это почта, используемая для входа в BondMemo и эту почту будут приходить напоминания.',
    ...
    'locale' => 'Язык',
    'locale_help' => 'Хотите помочь с переводом BondMemo или добавить новый язык? Перейдите по <a href=":url" target="_blank" lang="en">этой ссылке для получения дополнительной информации</a>.',
    'locale_ar' => 'Арабский',
    'locale_cs' => 'Чешский',
    'locale_de' => 'Немецкий',
    'locale_el' => 'Греческий',
    ...
    'users_list_invitations_explanation' => 'Below are the people you’ve invited to join BondMemo as a collaborator.',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade BondMemo today and have more meaningful relationships.',
    'subscriptions_account_upgrade_choice' => 'Pick a plan below and join over :customers persons who upgraded their BondMemo.',
    ...
    'subscriptions_help_discounts_desc' => 'We do! BondMemo is free for students, and free for non-profits and charities. Just contact <a href=":support">the support</a> with a proof of your status and we’ll apply this special status in your account.',
    ...
    'api_description' => 'API может использоваться для работы с данными BondMemo из внешнего приложения, например – мобильного приложения.',
    ...
    'api_endpoint' => 'Конечная точка API для этого экземпляра BondMemo:',
