...
return [
    ...
    'confirmation_email_title' => 'BondMemo – проверка электронной почты',
    ...
    'password_reset_title' => 'BondMemo – сброс пароля уведомления',
    ...
    'invitation_title' => 'BondMemo – Вас пригласил :name',
    'invitation_intro' => 'Вы были приглашены :name (:email) для использования BondMemo, отличного инструмента управления личными отношениями.',
