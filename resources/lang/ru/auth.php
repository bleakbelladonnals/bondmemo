...
return [
    ...
    */
    ...
    'register_title_welcome' => 'Добро пожаловать в ваш вновь установленный экземпляр BondMemo',
    'register_create_account' => 'Для использования BondMemo вам нужно создать аккаунт',
    'register_title_create' => 'Создайте свой аккаунт BondMemo',
