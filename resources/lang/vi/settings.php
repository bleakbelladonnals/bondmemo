...
return [
    ...
    'me_help' => 'Đây là liên hệ đại diện cho <em>bạn</em> trên BondMemo',
    ...
    'locale' => 'Ngôn ngữ',
    'locale_help' => 'Bạn có muốn hỗ trợ dịch BondMemo hoặc thêm ngôn ngữ mới? Hãy theo dõi <a href=":url" target="_blank" lang="en">thêm thông tin ở liên kết này</a>.',
    ...
    'users_list_invitations_explanation' => 'Dưới đây là những người bạn đã mời tham gia BondMemo với tư cách cộng tác viên.',
    ...
    'subscriptions_account_upgrade_title' => 'Nâng cấp BondMemo hôm nay và có thêm nhiều mối quan hệ ý nghĩa.',
    'subscriptions_account_upgrade_choice' => 'Chọn gói dưới đây và gia nhập hội :customers đã nâng cấp BondMemo.',
    ...
    'subscriptions_help_discounts_desc' => 'Chúng tôi có! BondMemo miễn phí cho sinh viên, tổ chức phi lợi nhuận và từ thiện. Hãy liên hệ <a href=":support">đội hỗ trợ</a> với bằng chứng về tình trạng của bạn và chúng tôi sẽ áp dụng trạng thái đặc biệt cho tài khoản của bạn.',
    ...
    'api_description' => 'API có thể dùng để tương tác với dữ liệu của BondMemo từ ứng dụng bên ngoài, như app điện thoại.',
    ...
    'api_endpoint' => 'Đường dẫn đích API cho BondMemo là:',
    ...
    'personalization_reminder_rule_desc' => 'Với mỗi nhắc nhở bạn cài, BondMemo có thể gửi email cho bạn vào x ngày trước khi sự kiện xảy ra. Bạn có thể điều chỉnh cài đặt thông báo ở đây. Thông báo này chỉ áp dụng cho lời nhắc hàng tháng và hàng năm.',

    'personalization_module_save' => 'Đã lưu thay đổi',
    'personalization_module_title' => 'Tính năng',
    'personalization_module_desc' => 'Có thể bạn không cần dùng tất cả tính năng của BondMemo. Phần dưới đây cho phép bạn bật/tắt tính năng sử dụng trong khung liên hệ. Thay đổi này sẽ ảnh hưởng đến TẤT CẢ liên hệ của bạn. Tắt tính năng không xóa dữ liệu, chỉ ẩn tính năng này đi.',
