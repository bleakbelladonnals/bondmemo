...
return [
    ...
    'confirmation_email_title' => 'BondMemo – Email xác thực',
    ...
    'password_reset_title' => 'BondMemo - Thông báo đặt lại mật khẩu',
    ...
    'invitation_title' => 'BondMemo - Bạn đã được mời bởi :name',
    'invitation_intro' => 'Bạn đã được mời sử dụng BondMemo bởi :name (:email), một công cụ Quản lý mối quan hệ cá nhân tuyệt vời.',
