...
return [
    ...
    'me_help' => 'Dit is het contact dat <em>jou</em> vertegenwoordigt in BondMemo',
    ...
    'email_help' => 'Dit is de e-mail die gebruikt wordt om in te loggen, en dit is waar naar toe BondMemo uw herinneringen zal sturen.',
    'timezone' => 'Tijdzone',
    ...
    'locale' => 'Taal',
    'locale_help' => 'Wil je helpen met het vertalen van BondMemo of een nieuwe taal toevoegen? <a href=":url" target="_blank" lang="en">Klik hier voor meer informatie.</a>',
    'locale_ar' => 'Arabisch',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade BondMemo vandaag en maak je persoonlijke relaties betekenisvoller.',
    'subscriptions_account_upgrade_choice' => 'Kies hieronder een abonnement en sluit je aan bij meer dan :customers personen die reeds de premium versie van BondMemo gebruiken.',
    ...
    'subscriptions_help_discounts_desc' => 'Jazeker! BondMemo is gratis voor studenten en goede doelen. Neem contact op met <a href=":support">support</a> met een passend bewijs (van inschrijving) en wij zullen deze speciale status aan je account toekennen.',
    ...
    'api_description' => 'De API kan worden gebruikt om de gegevens van BondMemo te gebruiken in een externe applicatie. Bijvoorbeeld een app op je mobiele telefoon.',
    ...
    'api_endpoint' => 'De \'API endpoint\' voor deze BondMemo-server is:',
