...
return [
    ...
    'me_help' => 'Questo è il contatto che rappresenta <em>te</em> a BondMemo',
    ...
    'export_sql_explanation' => 'Esportare i dati in formato SQL permette di importarli nella propria istanza di BondMemo. Questo è da considerare solo se si possiede un server.',
    'export_sql_cta' => 'Esporta in SQL',
    'export_sql_link_instructions' => 'Nota: <a href=":url">leggi le istruzioni</a> per capire come importare questo file nella tua istanza di BondMemo.',
    ...
    'email_help' => 'Questa è l\'email usata per accedere e dove BondMemo invierà i tuoi promemoria.',
    ...
    'locale' => 'Lingua',
    'locale_help' => 'Vuoi aiutare a tradurre BondMemo o ad aggiungere una nuova lingua? Segui <a href=":url" target="_blank" lang="en">questo link per ulteriori informazioni</a>.',
    'locale_ar' => 'Arabo',
    'locale_cs' => 'Ceco',
    'locale_de' => 'Tedesco',
    'locale_el' => 'Greco',
    ...
    'users_list_invitations_explanation' => 'Qui sotto trovi gli inviti a BondMemo come collaboratori.',
    ...
    'subscriptions_account_upgrade_title' => 'Aggiorna BondMemo oggi e ottieni relazioni più significative.',
    'subscriptions_account_upgrade_choice' => 'Scegli un piano e unisciti alle :customers persone abbonate a BondMemo.',
    'subscriptions_account_update_title' => 'Aggiorna l\'abbonamento di BondMemo',
    ...
    'subscriptions_downgrade_thanks' => 'Grazie mille per aver provato il piano a pagamento. Continuiamo sempre ad aggiungere nuove funzionalità su BondMemo, quindi potresti voler tornare in futuro per vedere se potresti esser interessato ad abbonarti di nuovo.',
    ...
    'subscriptions_help_discounts_desc' => 'Sì! BondMemo è gratuita per studenti, no-profit e organizzazioni di beneficienza. Basta contattare <a href=":support">il supporto clienti</a> con una prova del tuo status, e aggiorneremo il tuo account.',
    ...
    'api_description' => 'L\'API puó essere usata per manipolare le informazioni in BondMemo da un\'applicazione esterna, ad esempio da un\'applicazione per smartphone.',
    ...
    'api_endpoint' => 'L\'endpoint API per questa istanza BondMemo è:',
    ...
    'personalization_title' => 'Qui puoi trovare diverse impostazioni per configurare il tuo profilo. Queste funzionalità sono intese per "utenti esperti" che vogliono il massimo controllo su BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'Per ogni promemoria che imposti, BondMemo ti invierà un\'email un certo numero di giorni prima dell\'evento. Puoi regolare qui queste impostazioni di notifica. Queste notifiche si applicano solo a promemoria mensili e annuali.',

    'personalization_module_save' => 'Cambiamenti salvati',
    'personalization_module_title' => 'Funzionalità',
    'personalization_module_desc' => 'Potresti non necessitare di tutte le funzionalità di BondMemo. Sotto puoi attivare/disattivare funzionalità specifiche usate su una rubrica. Questa modifica influenzerà TUTTI i tuoi contatti. Disattivare una funzionalità non ne elimina tutti i dati, nasconde semplicemente la funzionalità.',
