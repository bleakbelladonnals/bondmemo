...
return [
    ...
    'confirmation_email_title' => 'BondMemo – Verifica Email',
    ...
    'password_reset_title' => 'BondMemo – Reimposta la tua password',
    ...
    'invitation_title' => 'BondMemo – Sei stato invitato da :name',
    'invitation_intro' => 'Sei stato invitato da :name (:email) a usare BondMemo, un buon strumento per la gestione delle relazioni personali.',
