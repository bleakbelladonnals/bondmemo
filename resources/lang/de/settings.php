...
return [
    ...
    'me_help' => 'Dies ist der Kontakt, der <em> Sie </em> in BondMemo vertritt',
    ...
    'email_help' => 'Mit dieser Adresse kannst du dich einloggen und dorthin sendet BondMemo auch deine Erinnerungen.',
    'timezone' => 'Zeitzone',
    ...
    'locale_help' => 'Möchtest du bei der Übersetzung von BondMemo helfen oder eine neue Sprache hinzufügen? Bitte folge <a href=":url" target="_blank" lang="en">diesem Link für weitere Informationen</a>.',
    'locale_ar' => 'Arabisch',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade BondMemo heute und mache deine persönlichen Beziehungen gehaltvoller.',
    'subscriptions_account_upgrade_choice' => 'Wähle eines der Abos und schließe dich :customers Personen an, die bereits die Premium-Version von BondMemo nutzen.',
    ...
    'subscriptions_help_discounts_desc' => 'Ja! BondMemo ist kostenlos für Schüler, Studenten und gemeinnützige Organisationen. Kontaktiere einfach <a href=":support">den Support</a> mit einem entsprechenden Nachweis und wir werden den speziellen Status auf deinen Account anwenden.',
    ...
    'api_description' => 'Über die API ist es möglich, BondMemo über eine externe Applikation zu nutzen, wie z.B. eine App auf deinem Handy.',
    ...
    'api_endpoint' => 'Der API-Endpunkt für diese BondMemo-Instanz ist:',
    ...
    'personalization_title' => 'Hier findest du verschiedene Einstellungsoptionen für deinen Account. Diese Funktionen sind eher für erfahrene Nutzer gedacht, die maximale Kontrolle über BondMemo möchten.',
    ...
    'personalization_reminder_rule_desc' => 'Für jede Erinnerung die du setzt, kann BondMemo dir ein paar Tage bevor das Ereignis stattfindet eine Email senden. Du kannst diese Benachrichtigungen hier anpassen. Diese Einstellungen gelten nur für monatliche und jährliche Erinnerungen.',

    'personalization_module_save' => 'Die Änderung wurde gespeichert',
    'personalization_module_title' => 'Funktionen',
    'personalization_module_desc' => 'Möglicherweise brauchst du nicht alle Funktionen von BondMemo. Unten kannst du die Funktionen umschalten, die auf einer Kontaktseite zur Verfügung stehen. Diese Änderungen werden für ALLE Kontakte übernommen. Wenn du eine Funktion ausschaltest, gehen die Daten darin nicht verloren, sie werden nur verborgen.',
