...
return [
    ...
    'me_title' => '代表自己的联系人',
    'me_help' => '这个联系人在BondMemo代表了 <em>你</em>',
    'me_select' => '选择联系人',
    ...
    'locale' => '应用程序中使用的语言',
    'locale_help' => '您想要帮助翻译BondMemo或添加新语言吗？请点击 <a href=":url" target="_blank" lang="en">了解更多信息</a>。',
    'locale_ar' => '阿拉伯文',
    'locale_cs' => '捷克文',
    'locale_de' => '德文',
    'locale_el' => '希腊文',
    ...
    'subscriptions_account_upgrade_title' => '立即升级您的BondMemo账户吧！',
    ...
    'subscriptions_help_discounts_desc' => '当然！BondMemo免费为学生，非盈利机构提供服务。您只需要提交一下材料给我们的 <a href=":support">支持人员</a>。',
    ...
    'personalization_title' => '你可以在这里配置你的账户。注意这些配置主要针对想要最大化控制 BondMemo 的高级用户。',
    ...
    'personalization_reminder_rule_desc' => '对于每个提醒，BondMemo 可以在事件发生的前几天向你发送电子邮件。你可以在此处配置这些通知。请注意,，这些通知只适用于月度和年度提醒。',

    'personalization_module_save' => '更改已被保存',
    'personalization_module_title' => '功能',
    'personalization_module_desc' => '你不必启用 BondMemo 的所有功能。你可以在下方切换联系人表上启用的功能。 此更改将影响你的所有联系人。 关闭功能不会删除任何数据，只会隐藏该功能。',
