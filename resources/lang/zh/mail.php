...
return [
    ...
    'confirmation_email_title' => 'BondMemo – Email 认证',
    ...
    'password_reset_title' => 'BondMemo — 重置密码通知',
    ...
    'invitation_title' => 'BondMemo — 您收到 :name 的邀请',
    'invitation_intro' => '您已被:name (:email)邀请使用 BondMemo, 个人社交关系管理工具。',
