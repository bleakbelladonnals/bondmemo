...
return [
    ...
    'me_help' => 'Αυτή είναι η επαφή που <em>σας</em> εκπροσωπεί στην BondMemo',
    ...
    'export_sql_explanation' => 'Η εξαγωγή των δεδομένων σε μορφή SQL σάς επιτρέπει να πάρετε τα δεδομένα και να τα εισαγάγετε σε μια δική σας εγκατάσταση του BondMemo. Αυτό είναι αξιοποιήσιμο μόνο εάν έχετε δικό σας διακομιστή (server).',
    ...
    'personalization_title' => 'Εδώ θα βρείτε διάφορες ρυθμίσεις για τη διαμόρφωση του λογαριασμού σας. Αυτές οι δυνατότητες προορίζονται για «προχωρημένους» χρήστες που θέλουν μέγιστο έλεγχο της BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'Για κάθε υπενθύμιση που ορίζετε, η BondMemo μπορεί να σας στείλει ένα email αρκετές ημέρες πριν από το γεγονός. Εδώ μπορείτε να προσαρμόσετε αυτές τις ρυθμίσεις ειδοποιήσεων. Αυτές οι ειδοποιήσεις ισχύουν μόνο για μηνιαίες και ετήσιες υπενθυμίσεις.',

    'personalization_module_save' => 'Η αλλαγή έχει αποθηκευτεί',
    'personalization_module_title' => 'Δυνατότητες',
    'personalization_module_desc' => 'Μπορεί να μην χρειάζεστε όλες τις δυνατότητες της BondMemo. Παρακάτω μπορείτε να αλλάξετε συγκεκριμένες λειτουργίες που δε χρειάζεστε στις καρτέλες επαφών. Αυτή η αλλαγή θα επηρεάσει την εμφάνιση σε ΟΛΕΣ τις επαφές σας. Η απενεργοποίηση μιας λειτουργίας δεν διαγράφει δεδομένα, απλώς αποκρύπτει τη δυνατότητα από τις καρτέλες επαφών.',
