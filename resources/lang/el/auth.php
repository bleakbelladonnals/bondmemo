...
return [
    ...
    */
    ...
    'register_title_welcome' => 'Καλώς ήλθατε στην νέα εγκατάσταση του BondMemo',
    'register_create_account' => 'Πρέπει να δημιουργήσετε έναν λογαριασμό για να χρησιμοποιήσετε το BondMemo',
    'register_title_create' => 'Δημιουργήστε το λογαριασμό BondMemo',
