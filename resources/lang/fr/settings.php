...
return [
    ...
    'me_help' => 'Ceci est le contact qui <em>vous</em> représente sur BondMemo',
    ...
    'export_sql_explanation' => 'L’exportation de vos données au format SQL vous permet de prendre vos données et de les importer dans votre propre instance BondMemo. Ceci n’est utile que si vous avez votre propre serveur.',
    ...
    'email_help' => 'Cette adresse courriel est utilisée pour vous connecter à votre compte, et c\'est aussi l\'adresse à laquelle BondMemo enverra vos rappels.',
    ...
    'locale' => 'Langue',
    'locale_help' => 'Voulez-vous aider à traduire BondMemo ou ajouter une nouvelle langue ? Veuillez suivre <a href=":url" target="_blank" lang="en">ce lien pour plus d’informations</a>.',
    'locale_ar' => 'Arabe',
    'locale_cs' => 'Tchèque',
    'locale_de' => 'Allemand',
    'locale_el' => 'Grec',
    ...
    'users_list_invitations_explanation' => 'Voici les personnes que vous avez invité à rejoindre BondMemo comme collaborateurs.',
    ...
    'subscriptions_account_upgrade_title' => 'Mettez à niveau BondMemo aujourd’hui et ayez des relations encore plus significatives.',
    'subscriptions_account_upgrade_choice' => 'Choisissez une offre ci-dessous et rejoignez plus de :customers personnes qui ont mis à niveau leur BondMemo.',
    'subscriptions_account_update_title' => 'Modifier l’abonnement à BondMemo',
    ...
    'subscriptions_downgrade_thanks' => 'Merci beaucoup d’avoir essayé l’offre payante. Nous continuons à apporter de nouvelles fonctionnalités sur BondMemo tout le temps – vous pouvez donc revenir à l’occasion pour voir si vous pourriez à nouveau être intéressé·e pour prendre un abonnement.',
    ...
    'subscriptions_help_opensource_desc' => 'BondMemo est un projet open source. Il est le fruit du travail d’une communauté de bénévoles qui veulent juste créer un outil pour le bien de tous. Être un projet open source signifie que le code est disponible pour tous sur GitHub, et que tout le monde peut l’inspecter, le modifier et l’améliorer. Tout l’argent que nous récoltons sert uniquement à créer des fonctionnalités, payer de nouveaux serveurs puissants, et autres coûts. Merci pour votre aide. Nous ne pourrions rien faire sans vous.',
    ...
    'subscriptions_help_discounts_desc' => 'En effet ! BondMemo est gratuit pour les étudiants, les organismes sans but lucratif et les organismes de bienfaisance. Il suffit de contacter le <a href=":support">support</a> avec un justificatif de votre statut et nous allons appliquer ce statut spécial dans votre compte.',
    ...
    'api_description' => 'L’API peut être utilisée pour manipuler les données de BondMemo depuis une application externe, comme une application mobile par exemple.',
    ...
    'api_endpoint' => 'Le point de terminaison de l’API pour cette instance BondMemo est :',
    ...
    'personalization_title' => 'Ici vous pouvez configurer les différents paramètres de votre compte. Ces fonctionnalités sont pour les « utilisateurs avancés » qui veulent un contrôle maximal sur BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'Pour chaque rappel que vous mettez en place, BondMemo peut envoyer un courriel plusieurs jours avant que l’évènement se passe. Vous pouvez ajuster ces préférences de notifications ici. Ces notifications ne s’appliquent qu’aux rappels mensuels et annuels.',
