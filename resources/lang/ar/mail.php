...
return [
    ...
    'confirmation_email_title' => 'BondMemo - تأكيد البريد الإلكتروني',
    ...
    'password_reset_title' => 'BondMemo – Reset Password Notification',
    ...
    'invitation_title' => 'BondMemo – You are invited by :name',
    'invitation_intro' => 'You’ve been invited by :name (:email) to use BondMemo, a nice Personal Relationship Management tool.',
