...
return [
    ...
    'users_list_invitations_explanation' => 'فيما يلي الأشخاص الذين قمتَ بدعوتهم للإنضمام إلى BondMemo كمتعاون.',
    ...
    'subscriptions_account_upgrade_title' => 'قم بترقية BondMemo اليوم و احصل على علاقات أكثر أهمية.',
    'subscriptions_account_upgrade_choice' => 'اختر خطة أدناه و انضم إلى :customers الأشخاص الذين قاموا بترقية BondMemo الخاص بهم.',
    ...
    'subscriptions_help_discounts_desc' => 'نعم لدينا! تطبيق BondMemo مجاني للطلاب، و مجاني لأسباب غير ربحية و للمؤسسات الخيرية. فقط تواصل مع <a href=":support">الدعم</a> بدليل على حالتك و سنقوم بتطبيق هذه الحالة الخاصة في حسابك.',
