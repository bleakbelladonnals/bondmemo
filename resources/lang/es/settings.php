...
return [
    ...
    'me_help' => 'Este es el contacto que te representa <em>a ti</em> en BondMemo',
    ...
    'export_sql_explanation' => 'Exportar tus datos en formato SQL te permite coger tu información e importarla en tu propia instancia de BondMemo. Esto es útil sólo si tienes tu propio servidor.',
    ...
    'locale_help' => '¿Quieres ayudar a traducir BondMemo o añadir un nuevo idioma? Sigue <a href=":url" target="_blank" lang="en">este enlace para más información</a>.',
    'locale_ar' => 'Árabe',
    'locale_cs' => 'Checo',
    'locale_de' => 'Alemán',
    'locale_el' => 'Griego',
    ...
    'users_list_invitations_explanation' => 'Debajo están las personas que has invitado a unirse a BondMemo como colaboradores.',
    ...
    'subscriptions_account_upgrade_choice' => 'Escoja un plan a continuación y únase a :clientes que mejoraron su BondMemo.',
    'subscriptions_account_update_title' => 'Actualizar suscripción de BondMemo',
    ...
    'subscriptions_downgrade_thanks' => 'Muchas gracias por probar el plan de pago. Seguimos añadiendo nuevas mejoras en BondMemo todo el tiempo, así que tal vez quieras volver en el futuro para ver si estás interesado en suscribirte de nuevo.',
    ...
    'api_description' => 'La API se puede utilizar para manipular los datos de BondMemo desde una aplicación externa, como una aplicación móvil por ejemplo.',
    ...
    'api_endpoint' => 'El punto final de la API para esta instancia de BondMemo es:',
    ...
    'personalization_reminder_rule_desc' => 'Por cada recordatorio que haya establecido, BondMemo puede enviarle un correo electrónico varios días antes de que el evento suceda. Puedes ajustar estos ajustes de notificación aquí. Estas notificaciones solo se aplican a recordatorios mensuales y anuales.',

    'personalization_module_save' => 'El cambio se ha guardado',
    'personalization_module_title' => 'Características',
    'personalization_module_desc' => 'Puede que no necesite todas las características de BondMemo. Debajo puede cambiar características específicas que se utilizan en una hoja de contacto. Este cambio afectará a TODOS tus contactos. Desactivar una función no elimina ningún dato, simplemente oculta la función.',
