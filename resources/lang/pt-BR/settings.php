...
return [
    ...
    'me_help' => 'Este é o contato que <em>te</em> representa em BondMemo',
    ...
    'email_help' => 'Este é o email usado para fazer login, e é para cá que BondMemo enviará seus lembretes.',
    ...
    'locale_help' => 'Você quer ajudar a traduzir BondMemo ou adicionar um novo idioma? Por favor, siga <a href=":url" target="_blank" lang="en">este link para mais informações</a>.',
    'locale_ar' => 'Árabe',
    'locale_cs' => 'Tcheco',
    'locale_de' => 'Alemão',
    'locale_el' => 'Grego',
    ...
    'users_list_invitations_explanation' => 'Abaixo estão as pessoas que você convidou para se juntar a BondMemo como colaborador.',
    ...
    'subscriptions_account_upgrade_title' => 'Faça um upgrade no BondMemo hoje e tenha relações mais significativas.',
    'subscriptions_account_upgrade_choice' => 'Escolha um plano abaixo e junte-se a :customers pessoas que fizeram upgrade em seu BondMemo.',
    ...
    'subscriptions_downgrade_thanks' => 'Muito obrigado por experimentar o plano pago. Continuamos adicionando novas funcionalidades à BondMemo o tempo todo - então você pode querer voltar no futuro para ver se pode estar interessado em fazer uma assinatura novamente.',
    ...
    'subscriptions_help_discounts_desc' => 'Sim! BondMemo é gratuita para estudantes e gratuita para instituições sem fins lucrativos e de caridade. Basta contatar <a href=":support">o suporte</a> com um comprovante de seu status e aplicaremos este status especial na sua conta.',
    ...
    'api_description' => 'A API pode ser usada para manipular os dados da BondMemo a partir de uma aplicação externa, como um aplicativo móvel por exemplo.',
    ...
    'api_endpoint' => 'A API endpoint para esta instância de BondMemo é:',
    ...
    'personalization_title' => 'Aqui você encontrará configurações diferentes para configurar sua conta. Esses recursos são destinados a "usuários masters" que querem o controle máximo sobre a BondMemo.',
    ...
    'personalization_reminder_rule_desc' => 'Para cada lembrete que você definiu, BondMemo pode enviar-lhe um e-mail por alguns dias antes do evento acontecer. Você pode ajustar estas configurações de notificação aqui. Estas notificações se aplicam apenas a lembretes mensais e anuais.',

    'personalization_module_save' => 'A alteração foi salva',
    'personalization_module_title' => 'Funcionalidades',
    'personalization_module_desc' => 'Você pode não precisar de todas as funcionalidades da BondMemo. Abaixo você pode alternar as funcionalidades específicas que são utilizadas em uma lista de contatos. Esta alteração afetará TODOS os seus contatos. Desativar um recurso não exclui nenhum dado, simplesmente oculta o recurso.',
