...
return [
    ...
    */
    ...
    'display_name' => env('APP_DISPLAY_NAME', env('APP_NAME', 'BondMemo')),
    ...
    |--------------------------------------------------------------------------
    |
    | Public installations can point users to the exact corresponding source.
    | Keep this environment-specific so forks never need to hard-code an owner.
    |
    */
