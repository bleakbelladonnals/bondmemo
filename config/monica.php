...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This is used to indicate which version of BondMemo you are running. You
    ...
    */
    ...
    | a configured release service to check if a new version is available.
    |
    */
    'check_version' => env('CHECK_VERSION', false),
    ...
    |--------------------------------------------------------------------------
    |
    | Your BondMemo instance has some statistics (number of users, number of
    | contacts,...). This setting can expose those data through a public API.
    ...
    */
    ...
    |
    */
    'weekly_ping_server_url' => env('VERSION_SERVER_URL'),
